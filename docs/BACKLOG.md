...
- [x] **Click-to-branch playback with a seamless jump-cut** *(the wow moment)*
...
- [x] **Choice prompt overlay timing**
...
- [x] **Preload strategy for branch targets**
...
- [x] **Design polish — player & overlay chrome**
...
- [x] **Scrubber reflects position within the current path**
...
- [x] **Graph view renders the full story shape**
...
- [x] **Path highlighting across a full playthrough**
...
- [x] **Design polish — scrubber & graph view**
...
- [x] **Sample multi-branch story ships with the playground**
...
- [x] **Error handling for malformed graphs**
